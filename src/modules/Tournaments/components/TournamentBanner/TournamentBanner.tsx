...
export const TournamentBanner: React.FC<Props> = ({ tournament }) => {
  ...
  const createTournamentParticipantResource = useResource(createTournamentParticipant);
        ...
        <div className={cls.bottomRow}>
          ...
          <div>
            <AuthenticationBouncer
              onAuthenticated={() => {
                createTournamentParticipantResource
                ...
                return (
                  <Button
                    ...
                    disabled={iAmParticipating || tournament.state !== 'pending'}
										isLoading={createTournamentParticipantResource.isLoading}
                    type="positive"
                    style={{
                      marginBottom: '0px',
                      paddingLeft: '10px',
