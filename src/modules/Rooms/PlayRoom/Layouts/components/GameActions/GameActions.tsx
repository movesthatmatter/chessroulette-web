...
import { ConfirmNewGameAction } from './widgets/ConfirmNewGameAction';
...
type Props = {
  ...
  className?: string;
  isMobile?: boolean;
  onActionTaken?: (a: keyof typeof gameActions) => void;
};
