// Taken as is from https://github.com/piotrwitek/react-redux-typescript-guide/blob/master/playground/typings/redux-thunk/index.d.ts
...
/**
* Takes a ThunkAction and returns a function signature which matches how it would
* appear when processed using
* bindActionCreators
*
